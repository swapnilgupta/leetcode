...
public class WordBreak {
	...
	/**
	 * Finding all the sentences that can be formed by breaking
	 * the input string into words present in the dictionary.
	...
	private void backtrack(String s, Set<String> words, List<String> result, List<String> path, boolean[] seen, int start) {
		if (start == s.length()) {
